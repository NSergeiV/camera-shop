...
function NoPage() {
  ...
  return (
    <div className='error-body'>
      <Helmet>
        <title>ERROR - такой нет страницы</title>
      </Helmet>
      <h1>
        <Link to={AppRoute.Catalog}>НАЖМИ ДЛЯ ПЕРЕХОДА НА ГЛАВНУЮ СТРАНИЦУ!!!</Link>
      </h1>
      <svg id="mainSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" >
        ...
        <g mask="url(#linesMask)">
          <use className="small" href="#warning" />
        </g>
        <g clipPath="url(#largeMask)">
